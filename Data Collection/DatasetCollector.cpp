...
#include "GUIs/imgui/imgui.h"
#include "GUIs/imgui/imgui_impl_glfw.h"
#include "GUIs/imgui/imgui_impl_opengl3.h"
...
// g++ DatasetCollector.cpp GUIs/ExperimentGUI.cpp GUIs/imgui/imgui.cpp GUIs/imgui/imgui_draw.cpp GUIs/imgui/imgui_tables.cpp GUIs/imgui/imgui_widgets.cpp GUIs/imgui/imgui_impl_glfw.cpp GUIs/imgui/imgui_impl_opengl3.cpp -o DatasetCollector -I"../iWorxDAQ_64" -L"../iWorxDAQ_64" -liwxDAQ -I"$env:VCPKG_ROOT/installed/x64-windows/include" -L"$env:VCPKG_ROOT/installed/x64-windows/lib" -lsqlite3 -I. -L. -lglfw3 -lopengl32
